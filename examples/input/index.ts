...
window.onload = () => {
  ...
  const assets = {
    characterModelAsset: new pc.Asset("model_mage", "model", { url: "../../assets/models/Mage.glb" }),
    characterTextureAsset: new pc.Asset("tex_mage", "texture", { url: "../../assets/textures/mage_texture.png" })
  }
