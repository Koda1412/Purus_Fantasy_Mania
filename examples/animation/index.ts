...
window.onload = () => {
  ...
  const assets = {
    charModelAsset: new pc.Asset("model", "model", { url: "../../assets/models/X/model_purus_girl.glb" }),
    charTextureAsset: new pc.Asset("tex", "texture", { url: "../../assets/textures/X/tex_purus_girl.jpg" }),
    charIdleAnimationAsset: new pc.Asset("anim_idle", "animation", { url: "../../assets/animations/X/anim_purus_girl_idle.glb" }),
    charRunAnimationAsset: new pc.Asset("anim_run", "animation", { url: "../../assets/animations/X/anim_purus_girl_run.glb"}),
  }
